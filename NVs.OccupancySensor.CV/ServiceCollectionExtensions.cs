...
namespace NVs.OccupancySensor.CV
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddPresenceDetection(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IPeopleDetector>(s => new BackgroundSubtractionDetector(s.GetService<ILogger<BackgroundSubtractionDetector>>() ?? throw new InvalidOperationException("BackgroundSubtractionDetector logger dependency was not resolved")));
