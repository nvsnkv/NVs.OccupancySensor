...
namespace NVs.OccupancySensor.CV.Utils
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddPresenceDetection(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IDenoiserFactory>(s => new DenoiserFactory(s.GetService<IConfiguration>()?.GetFastNlMeansColoredDenoisingSettings() ?? throw new InvalidOperationException("FastNlMeansColoredDenoising settings dependency was not resolved")));
